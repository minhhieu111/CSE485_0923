...
<body>
    <div class="container">
        <div class="form-control bg-warning mt-3 mb-3">
            <h1 class=" row justify-content-center">Sửa thông tin lớp</h1>
        </div>
            ...
            <div class="container">
                    <div class="row ">
                    <form action="/index.php?page=Classes&fun=edit" method="POST">
                            <h3 class = "text-center">Sửa thông tin lớp</h3>
                            ...
                            <a class="btn btn-warning mt-2" href="/index.php?page=Classes">Quay lại</a>
